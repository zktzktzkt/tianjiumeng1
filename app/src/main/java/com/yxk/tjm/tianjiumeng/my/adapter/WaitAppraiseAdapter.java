...
public class WaitAppraiseAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == WaitAppraiseAdapter.ADD) {
    ...
    public int getItemViewType(int position) {
        return position == getItemCount() - 1 ? WaitAppraiseAdapter.ADD : WaitAppraiseAdapter.NORMAL;
    }
